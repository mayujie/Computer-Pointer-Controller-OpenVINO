...
def main():
	...
	for flag_return, frame in inputFeeder.next_batch():
		...
		left_eye_box, right_eye_box, eye_coords = model_fld.predict(cropped_face.copy())
		...
		if (not len(preview_flags)==0):
			...
			if 'fld' in preview_flags:
				frame_copy = cropped_face
				cv2.rectangle(frame_copy, (eye_coords[0][0]-10, eye_coords[0][1]-10), (eye_coords[0][2]+10, eye_coords[0][3]+10), (255,255,255), 2)
				cv2.rectangle(frame_copy, (eye_coords[1][0]-10, eye_coords[1][1]-10), (eye_coords[1][2]+10, eye_coords[1][3]+10), (255,255,255), 2)
			...
			if 'ge' in preview_flags:				
				...
				cropped_face[eye_coords[0][1]:eye_coords[0][3],eye_coords[0][0]:eye_coords[0][2]] = line_left_eye
				cropped_face[eye_coords[1][1]:eye_coords[1][3],eye_coords[1][0]:eye_coords[1][2]] = line_right_eye
